      ...
      <div className="container-rtl">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          {services.map((activeService, index) => (
            <div key={activeService.id} className="grid lg:grid-cols-2 gap-12 items-center">
              <div className={`order-2 ${index % 2 === 0 ? 'lg:order-1' : 'lg:order-2'} direction-rtl`}>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground text-right">
                    {activeService.title}
                  </h3>
                </div>

                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 text-right">
                ...
                <div className="flex flex-wrap gap-8 mb-8">
                  {activeService.stats.map((stat, index) => (
                    <div key={index} className="text-center">
                      <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-accent mb-2 text-right">
                        {stat.value}
                      </div>
