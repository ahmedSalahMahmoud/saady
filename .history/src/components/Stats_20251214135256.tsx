      ...
      <div className="container-rtl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              {/* Icon */}
              <div className="w-20 h-20 md:w-24 md:h-24 mx-auto mb-6 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-accent/20 transition-colors">
