const Partners = () => {
  const partners = [
    ...
    { id: 6, name: 'شريك 1', logo: `/saady/partners/1.jpg` },
    { id: 7, name: 'شريك 2', logo: `/saady/partners/2.jpg` },
    { id: 8, name: 'شريك 3', logo: `/saady/partners/3.jpg` },
    { id: 9, name: 'شريك 4', logo: `/saady/partners/4.jpg` },
    { id: 10, name: 'شريك 5', logo: `/saady/partners/5.jpg` },
  ];
